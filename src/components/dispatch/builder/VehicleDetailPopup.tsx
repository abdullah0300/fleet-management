                                    ...
                                    {currentJob && (
                                        <div className="p-3 bg-white rounded-lg border space-y-2">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-xs text-muted-foreground">{(currentJob as any).customers?.name || currentJob.customer_name}</span>
                                            </div>
                                    ...
                                    {vehicleJobs.map(job => (
                                        <div key={job.id} className="flex items-center justify-between p-2 bg-slate-50 rounded-md text-sm">
                                            <div>
                                                ...
                                                <span className="text-muted-foreground ml-2">{(job as any).customers?.name || job.customer_name}</span>
                                            </div>
                                            <Badge variant="outline" className="text-xs">
                                                {job.status}
                                            </Badge>
