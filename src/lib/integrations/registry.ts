...
const INTEGRATIONS: TmsIntegration[] = [
    {
        ...
        logoText: 'CM',
        logoUrl: 'https://logo.clearbit.com/cargomatic.com',
    ...
    },
    {
        ...
        logoText: 'DAT',
        logoUrl: 'https://logo.clearbit.com/dat.com',
        category: 'load_board',
        status: 'coming_soon',
        authFields: [],
    },
    {
        ...
        logoText: '123',
        logoUrl: 'https://logo.clearbit.com/123loadboard.com',
        category: 'load_board',
        status: 'coming_soon',
        authFields: [],
    },
    {
        ...
        logoText: 'TS',
        logoUrl: 'https://logo.clearbit.com/truckstop.com',
        category: 'load_board',
        status: 'coming_soon',
        authFields: [],
    },
